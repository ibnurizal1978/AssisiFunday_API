...
<?php
$arr = array();
$s_v  = "SELECT cover_image, a.product_id, product_name, evoucher_code, voucher_info FROM tbl_evoucher_list a INNER JOIN tbl_evoucher b USING (evoucher_id) INNER JOIN tbl_product c ON b.product_id = c.product_id INNER JOIN tbl_shop d ON c.shop_id = d.shop_id WHERE order_code = '".$_REQUEST['order_code']."'";
...
while($r_v = mysqli_fetch_assoc($h_v)) {
  ...
  $evoucher_layout = '<table cellpadding=20 border=0 width=700 style="background:#E8FBFD">
  <tr>
  <td width=100 valign="top" align="center"><br/><br/><br/><img width="100" src='.$cover_image.'></td>
  ...
  <td valign="top" width=100 align="center">
      ...
      <b style="color:#226C85; font-size:14pt"><span class=yellow>'.$r_v['evoucher_code'].'</span></b>
  </td>
  </tr>
  </table><br/><br/>';
  $arr[] = $evoucher_layout;
...
//file_put_contents($_SERVER['DOCUMENT_ROOT']."/backend-main/public/images/qr/".$_REQUEST['order_code'].".pdf", $pdf); /* ini utk save di folder */
/* generate PDF */
